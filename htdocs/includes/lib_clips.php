...
function add_message($message)
{
	...
	if($message['n']=='')
	{
		$sql = "INSERT INTO ecs_goods" .
            " (cat_id , userid,  goods_name, goods_desc,goods_thumb ,goods_img  ,original_img )".
            " VALUES (4, '$message[user_id]', ".
            " '$message[msg_title]', '$message[msg_content]', '$message[imga]', '$message[imga]', '$message[imga]')";
	...
	{
		$sql = "INSERT INTO ecs_goods_gallery" .
            " (goods_id , img_url,  thumb_url, img_original )".
            " VALUES ('$message[n]', ".
            " '$message[imga]', '$message[imga]', '$message[imga]')";
    $GLOBALS['db']->query($sql);
