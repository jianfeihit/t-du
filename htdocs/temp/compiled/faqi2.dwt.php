...
?>
     ...
     <?php endif; ?>
        ...
        <tr align="center">
          <td bgcolor="#ffffff">发起活动名称</td>
          <td bgcolor="#ffffff">活动状态</td>
        </tr>
...
?>
        <tr>
          <td align="center" bgcolor="#ffffff"><a href="goods.php?id=<?php echo $this->_var['item']['goods_id']; ?>"><?php echo $this->_var['item']['goods_name']; ?></a></td>
          <?php if ($this->_var['item']['is_on_sale']): ?>
          <td align="center" bgcolor="#ffffff">已上架</td>
          <?php else: ?> 
          <td align="center" bgcolor="#ffffff">审核中</td>         
          <?php endif; ?>
        </tr>
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      </table>
