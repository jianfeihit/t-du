                    ...
                    <div class="navbar-inner">
                        <div class="container">
                            <ul class="nav">
                                ...
                                <li class="active"><a href="/goodsVote.php?id=3">班衫评选</a>
                    ...
                    <li class="span4">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <p>特价：<span class="label label-important"><?php echo $this->_var['goods']['shop_price']; ?></span>
                                  <p>票数：<span id="vote_<?php echo $this->_var['goods']['goods_id']; ?>" class="label"><?php echo $this->_var['goods']['votes']; ?></span></p>
                                  
                                </p>
                                <p>
                                    <a class="btn btn-small" onclick="submit_vote(<?php echo $this->_var['goods']['goods_id']; ?>)" href="javascript:void(0);">投票</a>
