...
?>
				<tr class="hui deepBlue" sid="46" aid="1042" pid="76102">
					<td colspan="2">
						<div class="comBox">
					...
					<td>
						<div class="number">
							S： <a href="#"> <input name="" type="text" value="<?php echo $this->_var['goods']['goods_number']; ?>" piid="397611" /> <span class="minus"> <img src="/v2/click.png" />
							</span> <span class="plus"> <img src="/v2/click.png" />
							</span>
							</a>
						</div>
					</td>
			...
			<div class="myShopBox">
				<div class="right">
					共 <strong id="total_qnt">1</strong> 件商品，商品总金额 <strong id="total_price">99</strong>元 <a class="butLarge commits" href="flow.php?step=t_cart_detail">去结算</a>
				</div>
