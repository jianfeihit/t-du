...
define ('DENGLU_PATH',ROOT_PATH.'denglu/');
...
if($denglu_cache['denglu_top']==1 && empty($_SESSION['user_id'])){
	$denglu_top_logo = "<li><script type='text/javascript' charset='utf-8' src='http://open.denglu.cc/connect/logincode?appid=".$denglu_cache['denglu_appid']."&style=popup'></script></li>";
